...
import PedidosPorMesBarChart from "./PedidosPorMesBarChart";
...
export default function PedidosPorMesCard({ data }: { data: MesData[] }) {
    ...
    <>
      ...
      >
        ...
        <div className="w-full flex justify-center">
          <PedidosPorMesBarChart data={data} height={280} />
        </div>
      ...
      {/* ✅ Modal Ampliado y Mucho Más Ancho */}
      {open && (
